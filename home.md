...
# GDCT
* [Minicurso Archai / UnB - 9/4 e 23/4](archai)  
    * [Prezi - Curso do GDCT](https://prezi.com/p/36gy_bivht4o/?present=1)  
...
* [Encontrando bibliografia relevante](Encontrando-bibliografia-relevante)
* [Driblando questões de acesso](acesso)

## Recursos filológicos
* [Fontes gregas](Fontes)
* [Dicionários](dict)
* [Dicionários em Grego](dict-ell)
* [Gramáticas de grego antigo](gramatica)
* [Corretor ortográfico de grego antigo](corretor)
* [Aplicativos para celular](apps)
* [CAT-Tools (Computer Assisted Translation)](cat)

## Formatos especiais
* [eBooks](eBooks)
* [Audiobooks](Audiobooks)
* [Transforme eBooks em websites](Transforme-eBooks-em-websites)

# Organização e exportação
## Ferramentas de escrita
* [Por que deveríamos parar de usar o Word](word)
* [Editores de texto](Editores-de-texto)
* [Editores de markdown](Editores-de-markdown)
* [Processadores de texto](Processadores-de-texto)
* [Gerenciadores de referências](bib)
* [Pandoc](Pandoc)
...
* [Compartilhando referências em pdfs via Dropbox](ref-dropbox)

# Automação
* [Macro para citar Aristóteles](citar)
* [Karabiner](Karabiner)
* [Workflows para Alfred](Workflows-para-Alfred)
* [RegEx](RegEx)
* [Padrões úteis de RegEx](padrões úteis)

# Aprendendo
* [O método natural](natural)
* [Aprendendo grego](Aprendendo-grego)

## CSS
* [Dark Mode no Diogenes](dark-diogenes)
* [Dark Mode no LWT](dark-lwt)

# Glossário
* [Wiki links automáticos](wiki-links)